<?php
    ...
    if(mysqli_connect_error()){
        ...
        if($er==0){
            ...
            $query = "SELECT * FROM spatsUsers WHERE e_mail = '".$_POST['email']."' AND password = '".$_POST['pass']."'";
            ...
            if ($result = mysqli_query($link, $query)){
                ...
                if($row){
                    ...
                    $result='<div class="alert alert-success mg"><strong>Hello!! ' .$row['name']. '!! Please Get a Screenshot of the QR code given Below to use SPATS</strong></div>';
                    
                    $image="<img src='https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=".$idu."'%2F&choe=UTF-8' title='".$row['name']."' />";
                    
                    
                }else{
                    
                    $error="E-mail not registered\n Please register first ";
                $result='<div class="alert alert-danger mg"><strong>'.$error.'</strong></div';
                }
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="index.html#topContainer">Home</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<button class="btn btn-success " id="mg"><a href="">Log IN</a></button>
					<button class="btn btn-success " id="mg"><a href="register.php">Sign UP</a></button>
				</ul>
			</div>
		</div>
	</div>
